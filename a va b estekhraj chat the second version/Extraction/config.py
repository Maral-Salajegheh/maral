...
# Only bounded trailing filler restoration on TD1 upper/name lines and TD2/TD3
# name lines is permitted. Lower data lines are never padded. Restorations trigger
# document review; checksums alone do not validate reconstructed text.
